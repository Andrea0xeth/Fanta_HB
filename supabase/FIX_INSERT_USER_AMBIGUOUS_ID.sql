-- ============================================
-- FIX: Risolve errore "column reference 'id' is ambiguous"
-- ============================================
-- Il problema è nella clausola ON CONFLICT che non distingue
-- tra il parametro p_id e la colonna id della tabella
...
-- Crea la funzione con ON CONFLICT usando il constraint name invece di (id)
...
BEGIN
  ...
  -- Usa ON CONFLICT ON CONSTRAINT invece di ON CONFLICT (id)
  -- per evitare ambiguità con il parametro p_id
